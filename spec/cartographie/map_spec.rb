...
describe Cartographie::Map do
  ...
  describe 'initialize map' do
    context "valid options" do
      let(:options) { { center: 'New York, NY', width: 75, height: 75, zoom: 10, file_format: 'jpg', sensor: true, maptype: 'satellite', points: points, api_endpoint: 'endpoint' } }
    ...
    context "no center or points" do
      it { lambda{ raise described_class.new.center.to_s }.should raise_error(Cartographie::MissingCenterOrMapPoint) }
    end
  end
